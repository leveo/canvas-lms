...
| --- | --- | --- |
| `C4C_CORRESPONDING_SOURCE_URL` | yes | Public `https://` (or `http://`) URL from which every remote user can copy the exact Corresponding Source for the deployed build at no charge. |
